...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( int quantity,  int totalPrice)?  quantityUpdated,TResult Function()?  placeOrderLoading,TResult Function( String orderId)?  placeOrderSuccess,TResult Function( String message)?  placeOrderError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
return placeOrderSuccess(_that.orderId);case _PlaceOrderError() when placeOrderError != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( int quantity,  int totalPrice)  quantityUpdated,required TResult Function()  placeOrderLoading,required TResult Function( String orderId)  placeOrderSuccess,required TResult Function( String message)  placeOrderError,}) {final _that = this;
switch (_that) {
case _Initial():
...
return placeOrderSuccess(_that.orderId);case _PlaceOrderError():
return placeOrderError(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( int quantity,  int totalPrice)?  quantityUpdated,TResult? Function()?  placeOrderLoading,TResult? Function( String orderId)?  placeOrderSuccess,TResult? Function( String message)?  placeOrderError,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _QuantityUpdated() when quantityUpdated != null:
return quantityUpdated(_that.quantity,_that.totalPrice);case _PlaceOrderLoading() when placeOrderLoading != null:
...
class _PlaceOrderSuccess implements CheckoutState {
  const _PlaceOrderSuccess({required this.orderId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PlaceOrderSuccess&&(identical(other.orderId, orderId) || other.orderId == orderId));
}
...
@override
String toString() {
  return 'CheckoutState.placeOrderSuccess(orderId: $orderId)';
}
...
/// @nodoc
abstract mixin class _$PlaceOrderSuccessCopyWith<$Res> implements $CheckoutStateCopyWith<$Res> {
